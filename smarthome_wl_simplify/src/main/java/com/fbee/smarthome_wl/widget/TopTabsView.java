package com.fbee.smarthome_wl.widget;
 ...
 * 头部Tab
 */
public class TopTabsView extends HorizontalScrollView {
	...
	private int tabTextCheckColor = Color.RED;
	private Typeface tabTypeface = null;
	private int tabTypefaceStyle = Typeface.NORMAL;
	private int lastScrollX = 0;
	private int tabBackgroundResId = R.drawable.tob_tabs_btn;
	...
	public TopTabsView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if (index == 0) {
					tab.setTextColor(tabTextCheckColor);
				} else {
	...
	public void setTextCheckColor(int textColor) {
		this.tabTextCheckColor = textColor;
		updateTabStyles();
	}
