...
/**
 * @class name：com.fbee.smarthome_wl.constant
 * @anthor create by Zhaoli.Wang
 * @time 2017/3/31 8:48
 */
public class DeviceList {
    public static final int DEVICE_ID_NOTEPAPER = 0;
    public static final int DEVICE_ID_SWITCH = 2;//智能开关
    public static final int DEVICE_ID_SWITCH_SCENE = 4;
    public static final int DEVICE_ID_SOCKET = 9;//开关插座
    ...
    public static final int DEVICE_ID_THTB2 = 770; //温度湿度传感器
    ...
    public static final int DEVICE_ID_SENSOR = 1026; //传感器
    public static final int DEVICE_ID_SAL = 1027;
    public static final int DEVICE_ID_CONTROL = 2048;
    public static final int DEVICE_ID_CONTROL_N = 2064;
    //门锁
    public static final int DEVICE_ID_DOOR_LOCK = 10;//门锁
    public static final int SENSOR_ZONE_TYPE_CIE = 0;
    public static final int SENSOR_ZONE_TYPE_HUMAN = 13; //人体
    public static final int SENSOR_ZONE_TYPE_DOOR = 21; //门磁
    public static final int SENSOR_ZONE_TYPE_SMOKE = 40; //烟雾
    public static final int SENSOR_ZONE_TYPE_SMOKE2 = 32768;
    public static final int SENSOR_ZONE_TYPE_WATER = 42; //水位
    public static final int SENSOR_ZONE_TYPE_GAS = 43;
    public static final int SENSOR_ZONE_TYPE_SBE = 44;
    public static final int SENSOR_ZONE_TYPE_VIBRATE = 45;
    public static final int SENSOR_ZONE_TYPE_SECURITY = 277;
    public static final int SENSOR_ZONE_TYPE_CO = 32769;
