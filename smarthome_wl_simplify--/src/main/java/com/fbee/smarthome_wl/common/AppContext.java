...
public class AppContext {
     ...
     * 本地服务器视频锁设备
     */
    public static  List<QueryGateWayInfoResponse.BodyBean.DeviceListBean> mVideoLockList;

    public List<QueryGateWayInfoResponse.BodyBean.DeviceListBean> getmVideoLockList() {
        return mVideoLockList;
    }

    public void setmVideoLockList(List<QueryGateWayInfoResponse.BodyBean.DeviceListBean> mVideoLockList) {
        this.mVideoLockList = mVideoLockList;
    }
