...
public class AppUtil {
    ...
    /**
     * 获取versionCode
     * Created by ZhaoLi.Wang on 2016/12/9 8:22
     */
    ...
    /**
     * 判断APP是否处在前台进程
     * Created by ZhaoLi.Wang on 2016/12/12 16:33
     */
    ...
    public static String getGateWayIp(DhcpInfo dhcpInfo) {
    ...
    public static String getLocalWifiSSID(WifiManager wifiManager) {
    ...
    public static ArrayList<String> getImagePathFromSD(String Equespath) {
        // 图片列表
        ArrayList<String> imagePathList = new ArrayList<String>();
        // 得到sd卡内image文件夹的路径 File.separator(/)
        // 得到该路径文件夹下所有的文件
        File fileAll = new File(Equespath);
        fileAll.exists();
