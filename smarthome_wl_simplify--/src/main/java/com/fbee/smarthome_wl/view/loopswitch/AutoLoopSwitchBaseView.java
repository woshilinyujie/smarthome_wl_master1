...
public abstract class AutoLoopSwitchBaseView extends RelativeLayout implements ViewPager.OnPageChangeListener {
  ...
  private final static int VIEWPAGER_SCROLL_DURTION = 400;
  ...
  private void initView() {
    ...
    params = generalLayoutParams(LayoutParams.MATCH_PARENT, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, AppUtil.dp2px(context,6), displayMetrics));
