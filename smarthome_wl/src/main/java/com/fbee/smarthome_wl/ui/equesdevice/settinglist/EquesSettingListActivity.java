        ...
        mSubscription = RxBus.getInstance()
                ...
                .subscribe(new Action1<EquesDevicePIRInfo>() {
                    ...
                    public void call(EquesDevicePIRInfo equesDevicePIRInfo) {
                        hideLoadingDialog();
                        capture_num = equesDevicePIRInfo.getCapture_num();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_right_menu:
                ...
                //抓拍数量
                CaptureMsg = tvContinuousCapture.getText().toString();
                if (TextUtils.isEmpty(CaptureMsg)) {
                } else {
                    String substring = CaptureMsg.substring(0, devicePirtime.getText().length() - 1);
                    capture_num = Integer.parseInt(substring);
                }
