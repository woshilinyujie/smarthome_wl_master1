...
public class YsplayActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void initData() {
        ...
        SurfaceHolder holder = ysSv.getHolder();
...
// 获取配置信息操作对象
        ...
        mScreenOrientationHelper = new ScreenOrientationHelper(this, ysScreen, null);
        updateOrientation();
    ...
    @OnClick({R.id.ys_sv, R.id.ys_time, R.id.ys_connection, R.id.ys_guaduan, R.id.ys_jinyin, R.id.ys_kaisuo})
